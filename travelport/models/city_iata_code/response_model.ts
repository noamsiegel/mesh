// To parse this data:
//
//   import { Convert, CityIataCodeResponse } from "./file";
//
//   const cityIataCode = Convert.toCityIataCodeResponse(json);

export interface CityIataCodeResponse {
...
export class Convert {
  public static toCityIataCodeResponse(json: string): CityIataCodeResponse {
      return JSON.parse(json);
  }

  public static cityIataCodeToJson(value: CityIataCodeResponse): string {
